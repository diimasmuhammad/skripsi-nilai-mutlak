...
import { soal as dataSoal } from "../components/data/latihanDua/dataSoal";
...
import DataDiriLatihanDua from "../components/latihan/DataDiriLatihanDua";
import { useTimer } from "react-timer-hook";

export default function latihanBabDua(props) {
  ...
  const koleksiUser = collection(db, "latihandua");
  ...
  useEffect(() => {
    ...
    const q = query(koleksiKkm, where("id", "==", "2"));
                    ...
                    {skor.benar * 10 < action.kkm ? (
                      ...
                      <Stack sx={{ width: "100%" }} spacing={2}>
                        <Alert severity="success">
                          Nilai Anda Memenuhi KKM, Silahkan ke Materi
                          Selanjutnya
                        </Alert>
                      </Stack>
                    )}
